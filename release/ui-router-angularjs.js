...
(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ? factory(exports, require('angular'), require('@uirouter/core'))
    : typeof define === 'function' && define.amd
      ? define(['exports', 'angular', '@uirouter/core'], factory)
      ...
      /** @hidden */ this.$get = [
        ...
        function($http, $templateCache, $injector) {
          _this.$templateRequest =
            $injector.has && $injector.has('$templateRequest') && $injector.get('$templateRequest');
          _this.$http = $http;
  ...
  var Ng1LocationServices = /** @class */ (function() {
    ...
    Ng1LocationServices.monkeyPatchPathParameterType = function(router) {
      ...
      pathType.encode = function(x) {
        return x != null
          ? x.toString().replace(/(~|\/)/g, function(m) {
              return { '~': '~~', '/': '~2F' }[m];
            })
          : x;
      };
      pathType.decode = function(x) {
        return x != null
          ? x.toString().replace(/(~~|~2F)/g, function(m) {
              return { '~~': '~', '~2F': '/' }[m];
            })
          : x;
      };
  ...
  function $uiRouterProvider($locationProvider) {
    ...
    var ng1LocationService = (router.locationService = router.locationConfig = new Ng1LocationServices(
      $locationProvider,
    ));
  ...
  var getStateProvider = function() {
    return core.extend(router.stateProvider, {
      $get: function() {
  ...
  ng
    ...
    .directive('uiState', uiStateDirective); /** for typedoc */
        ...
        return function(scope, $element) {
          ...
          if (controller) {
            var controllerInstance = $controller(
              controller,
              core.extend({}, locals, { $scope: scope, $element: $element }),
            );
            if (controllerAs) {
  ...
  function registerControllerCallbacks($q, $transitions, controllerInstance, $scope, cfg) {
    ...
    if (core.isFunction(controllerInstance.uiCanExit)) {
      ...
      var prevTruthyAnswer_1 = function(trans) {
        return (
          !!trans &&
          ((trans[cacheProp_1] && trans[cacheProp_1][id_1] === true) || prevTruthyAnswer_1(trans.redirectedFrom()))
        );
      };
